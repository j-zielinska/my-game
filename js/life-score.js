class LifeScore {
    ...
    draw() {
        ...
        text(this.scores, width - 15 - this.x, this.y + 30);


        fill(175,238,238)
        rect (this.pointX, this.pointY, this.lifeW , this.pointH, this.pointR )      // life       
        

        fill(255,255,255,63)        
        length = width - this.width - this.x + 2.5
        fill(250,128,114)
        rect (length, this.pointY, this.scoreW , this.pointH, this.pointR )  // score
